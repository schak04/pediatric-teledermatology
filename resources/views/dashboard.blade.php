                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    @if(auth()->user()->role === 'patient')
                        <div class="p-6 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                            ...
                            <a href="#" class="inline-block px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors">View Cases</a>
                        </div>
                        <div class="p-6 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                            ...
                            <a href="#" class="inline-block px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors">Submit Case</a>
                        </div>
                    @else
                        <div class="p-6 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                            ...
                            <a href="#" class="inline-block px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors">View Pending</a>
                        </div>
                        <div class="p-6 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                            ...
                            <a href="#" class="inline-block px-4 py-2 bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-white rounded-md text-sm font-medium hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors">View History</a>
                        </div>
                    @endif
                </div>
            </div>
